package com.vance.premissionstudy.permission.aspect;
...
import com.vance.premissionstudy.permission.annotation.Permission;
import com.vance.premissionstudy.permission.annotation.PermissionCancel;
import com.vance.premissionstudy.permission.annotation.PermissionDenied;
import com.vance.premissionstudy.permission.core.IPermission;
import com.vance.premissionstudy.permission.util.PermissionUtils;
...
public class PermissionAspect {
    ...
    // * * 任何函数 都可以使用 此注解
    @Pointcut
    ("execution(@com.vance.premissionstudy.permission.annotation.Permission * *(..)) && @annotation(permission)")
